            ...
            <Group justify="space-between" align="flex-start" wrap="nowrap" gap="md">
              <Group align="flex-start" wrap="nowrap" gap="sm" style={{ flex: 1 }}>
                ...
                <Box>
                  ...
                  <Text size="xs" c="dimmed" mt={2} data-testid="auto-unfollow-description">
                    Review the exact recommendations, deselect any account, confirm the visible set once,
                    then unfollow every approved account in order through the X API.
                  </Text>
                </Box>
              </Group>
              <Switch
